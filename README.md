...
You can view the live stream on a PC or Laptop by going to the Ustream channel URL in a browser.  This can be accessed using the ![](./images/ustream-channel-icon.png "UStream channel icon") icon which lives to the right of your channel name under **CHANNLES** in the Ustream dashboard.  See the green square in the screen shot above.
